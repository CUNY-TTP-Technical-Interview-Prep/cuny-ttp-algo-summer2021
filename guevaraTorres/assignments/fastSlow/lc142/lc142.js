...
/**
 * Since fast can reach slow, it will be behind slow at some point
 * So, if fast = slow.value
 * 
 */
...
// function calculate_cycle_length(slow) {  //increments the length until current matches slow
//   let current = slow,
//     cycle_length = 0;
//   while (true) {
