...
While current pointer is less than nums.length
Check if the current pointer is not equivalent to the index value
Then declare a swap pointer with the value before the current pointer
If current pointer is equivalent to the index value, increment the current pointer.

variables: current, swap
