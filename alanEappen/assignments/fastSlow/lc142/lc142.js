...
output: return the starting node

variable
slowPtr, fastPtr, length of the linkedlist

-first we need to find if linkelist is a cycle
-then we need to find the starting point
-finding if it a cycle
slowPtr and fastPtr = to head
while the fastPtr and fastPtr.next exits
slowptr = slowptr.next
fastptr = fastptr.next.next
 if slowptr and fastptr is equal
 reintialize 
