...
/*
inputs: array of N Interval objects
outputs: true/false depending on whether the person can attend all the appointments

steps:
- return true if there is only one interval
- sort the array of intervals based on start values
- loop through the array until the second to last element
    compare the start/end of each interval  --> i.end > i+1.start
